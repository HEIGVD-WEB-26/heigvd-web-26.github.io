...
Ce labo est une suite du second labo sur Tetris. Toutes les informations données dans 
[l'énoncé du précédent labo](./labo-4-tetris-2.html) restent donc valables pour celui-ci.
